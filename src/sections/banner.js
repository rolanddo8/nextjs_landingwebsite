  ...
  return (
    <Box as="section" id="banner" sx={styles.banner}>
      <Container sx={styles.container}>
        ...
        <Heading as="h2">Puzzle Coffee Shop</Heading>
        <Heading as="h3">Opening Hours</Heading>
        <Heading as="h3">6:00 - 20:00</Heading>
...
const styles = {
  banner: {
    ...
    h2: {
      fontSize: ['28px', null, null, '32px', '38px', '48px', '54px'],
      lineHeight: 1.25,
      color: '#02073E',
      fontWeight: 700,
      width: '100%',
      ...
      mx: 'auto',
      mt: '20px',
      mb: ['40px', null, null, '27px'],
    },
    h3: {
      ontSize: ['28px', null, null, '32px', '38px', '48px', '64px'],
      lineHeight: 1.25,
      color: '#02073E',
      fontWeight: 500,
      width: '100%',
      maxWidth: ['100%', null, null, '55%', '500px', '640px', '551px'],
      mx: 'auto',
      mt: '-5px',
      mb: ['0px', null, null, '10px'],
    }
  },
  logo: {
    display: 'block',
