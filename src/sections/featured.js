...
import { Cake, ChildCare, Favorite, Fastfood } from '@material-ui/icons';
  ...
  return (
    <Box as="section" sx={styles.featured}>
      <Container sx={styles.container}>
        <BlockTitle
          title="Functions booking"
          text="Book the our function venue with the beautiful view in Brisbane"
        />
